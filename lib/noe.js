        ...
        register(name, args) {
            ...
            if (args === undefined) {
                if (typeof name === 'string') {
                    throw new TypeError('malformed parameters for minimjs#use: with one params call, the first must be a function (factory-function, constructor-function or class) or array');
                }
                ...
                throw new TypeError('malformed parameters for minimjs#use');
            }
